...
export const Modal = ({
    ...
    return (
        <div
            className={`animate-fade-in-out ${show ? 'show' : ''} flex items-start justify-center w-full h-full fixed top-0 left-0 right-0 bottom-0 backdrop-filter backdrop-blur-md`}
